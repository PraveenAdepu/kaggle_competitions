...
MODEL_WEIGHTS_FILE = inDir + '/Prav_CNN03.h5'
...
#build_index, valid_iindex,y_build, y_valid = train_test_split(y_index, y, test_size=0.2, random_state=random_state, stratify=y)
#
#
#X_build = X[build_index]
#y_build =y[build_index]
#
#X_valid = X[valid_iindex]
#y_valid =y[valid_iindex]
...
submission.to_csv(inDir+'/submissions/Prav_CNN03.csv')
