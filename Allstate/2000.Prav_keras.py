...
df.to_csv('C:/Users/padepu/Documents/R/14Allstate/submissions/preds_oob_keras_01.csv', index = False)

## test predictions
pred_test /= (nfolds*nbags)
df = pd.DataFrame({'id': id_test, 'loss': pred_test})
df.to_csv('C:/Users/padepu/Documents/R/14Allstate/submissions/submission_keras_01.csv', index = False)
