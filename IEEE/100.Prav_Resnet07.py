...
images_train = pd.read_csv(inDir + '/input/Prav_5folds_CVindices_includingAugmentationPatches_v2.csv')
...
i=1
def dlnet(i):
    MODEL_WEIGHTS_FILE = inDir + '/Prav_'+ModelName+'_'+str(i)+'.h5'
    MODEL_FILE = inDir+'/Prav_Model_'+ModelName+'_'+str(i)+'.h5'
