...
train_features_30 = read_csv("./input/train_features_30.csv")
test_features_30  = read_csv("./input/test_features_30.csv")

train_df = left_join(train_df, train_features_30, by = 'id')
test_df  = left_join(test_df, test_features_30, by = 'test_id')

names(train_features_30)
names(test_features_30)
...
feature.names     <- c('q_dist_soundex'
                       ...
                       'z_noun_match',
                       'z_match_ratio',
                       'z_word_match',   "wmd"  , "norm_wmd"  ,            
                       'q1_freq',
                       'q2_freq','q1_q2_intersect')
...
sum(train_features_30$q1_q2_intersect)
summary(train_features_30$q1_q2_intersect)
head(train_df$q1_q2_intersect,20)

summary(test_df$q1_q2_intersect)
head(train_features_30$q1_q2_intersect,20)
head(test_features_30$q1_q2_intersect,20)
...
# Interactionfeatures <- c(  "word_q1_2w"       
#                            ,"q1_q2_freq_2w"   
#                            ,"word_3gram_2w"   
#                            ,"tfidf_q1_2w"      
#                            ,"qpmin_q2_freq_2w" 
...
# )
# 
# feature.names <- union(feature.names, Interactionfeatures)
##################################################################################################################################
##################################################################################################################################
  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  './submissions/prav.xgb100.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb100.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  './submissions/prav.xgb100.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb100.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  './submissions/prav.xgb100.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb100.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  './submissions/prav.xgb100.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb100.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  './submissions/prav.xgb100.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb100.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
...
write.csv(testfull_predictions, './submissions/prav.xgb100.full.csv', row.names=FALSE, quote = FALSE)
...
sub_valfile = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb100.fold' + str(i) + '.csv'
...
sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb100.fold' + str(i) + '-test' + '.csv'
...
sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb100.full' + '.csv'
