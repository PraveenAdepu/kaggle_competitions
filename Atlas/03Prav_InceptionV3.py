# -*- coding: utf-8 -*-
"""
Created on Sun Dec  9 20:12:13 2018
...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  9 16:42:19 2018
...
checkpoint = ModelCheckpoint(inDir+'/Prav_base03.model', monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='min', period=1)
...
bestModel = load_model(inDir+'/Prav_base03.model', custom_objects={'f1': f1}) #, 'f1_loss': f1_loss})
...
submit.to_csv(inDir+'/submissions/Prav_Inception02.csv', index=False)
