...
test_data_224_3    = np.load(inDir +"/input/test_data_rotate_aug_224_3.npy")
test_id_224_3      = np.load(inDir +"/input/test_id_rotate_aug_224_3.npy")
...
#    sub_valfile = inDir + '/submissions/Prav.dense169_04.fold' + str(i) + '.csv'
...
#    pred_cv.to_csv(sub_valfile, index=False)
    ...
    sub_file = inDir + '/submissions/Prav.dense169_04_r.fold' + str(i) + '-test'+'.csv'
