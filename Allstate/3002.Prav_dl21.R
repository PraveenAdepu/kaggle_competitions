...
for (i in 1:cv)
{
  ...
  for (b in 1:bags) 
  {
    ...
    Model <- h2o.deeplearning(
      ...
      distribution="huber",
      hidden=c(100,100),			          # select hidden topology (smaller is faster)
  ...
  if(i == 1)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl21.fold1.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl21.fold1-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 2)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl21.fold2.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl21.fold2-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 3)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl21.fold3.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl21.fold3-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 4)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl21.fold4.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl21.fold4-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 5)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl21.fold5.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl21.fold5-test.csv", sep=''), row.names=FALSE, quote = FALSE)
...
write.csv(fulltest_predictions,paste(root_directory, "./submissions/prav.dl21.full.csv", sep=''), row.names=FALSE, quote = FALSE)
