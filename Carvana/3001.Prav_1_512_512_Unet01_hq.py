...
MODEL_WEIGHTS_FILE = inDir + '/Unet_CCN02_weights_hq.h5'

train_file = inDir + "/CVSchema/Prav_CVindices_10foldshq.csv"
test_file = inDir + "/input/test_imageshq.csv"
...
train_data_224_3   = np.load(inDir +"/input/train_data_512_1_hq.npy")
train_target_224_3 = np.load(inDir +"/input/train_target_512_1_hq.npy")
train_id_224_3     = np.load(inDir +"/input/train_id_512_1_hq.npy")


test_data_224_3    = np.load(inDir +"/input/test_data_512_1_hq.npy")
test_id_224_3      = np.load(inDir +"/input/test_id_512_1_hq.npy")

train_data_224_3, train_target_224_3, train_id_224_3 = read_and_normalize_train_data()
test_data_224_3, test_id = read_and_normalize_test_data()
...
#    val_image = (val_image[:, :, 0] * 255.).astype(np.uint8)
    ...
    np.save('imgs_mask_test10_Unet_CNN02_hq.npy', imgs_mask_test)
