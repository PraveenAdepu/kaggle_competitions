...
def get_unet_resnet(input_shape):
    resnet_base = ResNet50(include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000)
    ...
    vgg = VGG16(input_shape=( 224, 224,3), input_tensor=resnet_base.input, include_top=False)
    for l in vgg.layers:
        l.trainable = False
