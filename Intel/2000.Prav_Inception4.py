...
def create_submission(predictions, test_id, info):
    ...
    sub_file = 'submissions\Prav.inception4.CNN01_' + info + '_' + str(now.strftime("%Y-%m-%d-%H-%M")) + '.csv'
...
def run_cross_validation_create_models(nfolds=10):
    ...
    train_data = train_data_299_3
    train_target = train_target_299_3
    train_id = train_id_299_3
...
#        model = create_model()# Load our model
        model = inception_v4_model(ROWS, COLUMNS, CHANNELS, num_classes=3)
...
def run_cross_validation_process_test(info_string, models):
    ...
    for i in range(nfolds):
        ...
        num_fold += 1
        print('Start KFold number {} from {}'.format(num_fold, nfolds))
        test_data = test_data_299_3
        test_id = test_id_299_3
