...
resnet101_weights = 'C:/Users/SriPrav/Documents/R' + '/imagenet_models/resnet101_weights_th.h5'
MODEL_WEIGHTS_FILE = inDir + '/resnet101_CCN01_weights.h5'
...
def resnet101_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    weights_path = resnet101_weights
...
def create_submission(predictions, test_id, info):
    ...
    sub_file = 'submissions\Prav.resnet101.CNN01_' + info + '_' + str(now.strftime("%Y-%m-%d-%H-%M")) + '.csv'
...
#        model = create_model()# Load our model
        model = resnet101_model(ROWS, COLUMNS, CHANNELS, num_classes=3)
