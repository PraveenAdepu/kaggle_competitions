...
train            = pd.read_csv('C:/Users/SriPrav/Documents/R/14Allstate/input/train_nnetcombifeatures.csv')
test             = pd.read_csv('C:/Users/SriPrav/Documents/R/14Allstate/input/test_nnetcombifeatures.csv')
...
def nn_model():
    ...
    model.add(Dense(5000, input_dim = X_train.shape[1], init = 'he_normal'))
    model.add(PReLU())
...
#    if i == 1:  
#        pred_cv_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold1.csv', index = False)   
#        pred_test_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold1-test.csv', index = False)
#    if i == 2:  
#        pred_cv_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold2.csv', index = False)   
#        pred_test_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold2-test.csv', index = False)
#    if i == 3:  
#        pred_cv_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold3.csv', index = False)   
#        pred_test_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold3-test.csv', index = False)
#    if i == 4:  
#        pred_cv_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold4.csv', index = False)   
#        pred_test_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold4-test.csv', index = False)
#    if i == 5:  
#        pred_cv_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold5.csv', index = False)   
#        pred_test_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.fold5-test.csv', index = False)
...
pred_fulltest_df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/prav.keras11.full.csv', index = False)
