...
def train_xgboost(i):
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE00.bl02.fold' + str(i) + '.csv'
    pred_cv.to_csv(sub_valfile, index=False)
    
    pred_test = np.clip(clf.predict(test_x),0.001,1)
    test_df['cancer'] = pred_test
    
    sub_file = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE00.bl02.fold' + str(i) + '-test' + '.csv'
...
def fulltrain_xgboost(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE00.bl02.full' + str(i) + '-bags' + '.csv'
    test_df.to_csv(sub_file, index=False)
