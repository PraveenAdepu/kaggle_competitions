...
logFeatureFreqs$DifffeatureFreq <- logFeatureFreqs$MaxfeatureFreq - logFeatureFreqs$MaxfeatureFreq 
...
# require(GGally)
# ggpairs(Fulltrain[c(3,462:468,470:484)], colour="fault_severity", alpha=0.4)
...
param <- list("objective" = "multi:softprob",    # multiclass classification 
              ...
              "eta" = 0.02,    # step size shrinkage  # 0.5
...
write.csv(prediction, "submission4610.csv", quote=FALSE, row.names = FALSE)
