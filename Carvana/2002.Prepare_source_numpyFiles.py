...
######################################################################################################################
np.save(inDir +"/input/train_data_512_1_hq.npy",train_data)
np.save(inDir +"/input/train_target_512_1_hq.npy",train_target)
np.save(inDir +"/input/train_id_512_1_hq.npy",train_id)

np.save(inDir +"/input/test_data_512_1_hq.npy",test_data)
np.save(inDir +"/input/test_id_512_1_hq.npy",test_id)
######################################################################################################################
