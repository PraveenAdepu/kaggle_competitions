# -*- coding: utf-8 -*-
"""
Created on Sun Mar 19 15:10:21 2017
...
def create_submission(predictions, test_id, info):
    ...
    sub_file = 'submissions\Prav_submission_' + info + '_' + str(now.strftime("%Y-%m-%d-%H-%M")) + '.csv'
...
def vgg_std16_model(ROWS, COLUMNS, CHANNELS=3):
    ...
    model.load_weights('C:/Users/SriPrav/Documents/R/22Intel/preModels/vgg16_weights.h5')
