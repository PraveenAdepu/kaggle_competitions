...
Imp.features <- c("Diabetes"
                  ...
                  ,"lag3_ChronicIllness"
                  ,"lag7_ChronicIllness"
                  ,"lag38_ChronicIllness"
                  ,"lag30_RepeatsLeft_Qty"
                  ,"lag36_RepeatsLeft_Qty"
                  ,"lag27_RepeatsLeft_Qty"
                  ,"lag37_RepeatsLeft_Qty"
                  ,"lag35_RepeatsLeft_Qty"
                  ,"lag29_RepeatsLeft_Qty"
                  ,"Urology"
                  ,"IsBannerGroup"
                  ,"PatientStateCode"
                  ,"Immunology"
...
feature.names <- setdiff(feature.names, Imp.features)
  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  './submissions/prav.xgb30.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb30.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  './submissions/prav.xgb30.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb30.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  './submissions/prav.xgb30.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb30.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  './submissions/prav.xgb30.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb30.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  './submissions/prav.xgb30.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb30.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
...
write.csv(testfull_predictions, './submissions/prav.xgb30.full.csv', row.names=FALSE, quote = FALSE)
...
val_sub <- read.csv("./submissions/prav.xgb30.full.csv")
...
write.csv(Final_sub,  './submissions/Prav_xgb30_rank.csv', row.names=FALSE, quote = FALSE)
#########################################################################################################
