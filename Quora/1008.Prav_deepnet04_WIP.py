...
EMBEDDING_DIM = 300
MODEL_WEIGHTS_FILE = 'dn4_question_pairs_weights.h5'
...
Q3.add(LSTM(EMBEDDING_DIM, dropout_W=0.2, dropout_U=0.2))

Q4 = Sequential()
Q4.add(Embedding(nb_words + 1, EMBEDDING_DIM, input_length=MAX_SEQUENCE_LENGTH, dropout=0.2))
Q4.add(LSTM(EMBEDDING_DIM, dropout_W=0.2, dropout_U=0.2))


model = Sequential()
model.add(Merge([Q1, Q2, Q3, Q4], mode='concat'))
...
model.load_weights('C:/Users/SriPrav/Documents/R/23Quora/dn4_question_pairs_weights.h5')
