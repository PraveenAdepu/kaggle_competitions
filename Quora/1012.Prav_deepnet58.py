...
train_df = pd.merge(train_df, train_features_36, how = 'left', on = 'id')
test_df = pd.merge(test_df, test_features_36, how = 'left', on = 'test_id')
...
train_df = pd.merge(train_df, train_features_37, how = 'left', on = 'id')
test_df = pd.merge(test_df, test_features_37, how = 'left', on = 'test_id')
