...
for (inTr, inTe) in folds:
    ...
    for j in range(nbags):
        ...
        fit = model.fit_generator(generator = batch_generator(xtr, ytr, 128, True),
                                  ...
                                  verbose = 2,validation_data=(xte.todense(),yte))
...
df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/preds_oob_keras02_2.csv', index = False)

## test predictions
pred_test /= (nfolds*nbags)
df = pd.DataFrame({'id': id_test, 'loss': pred_test})
df.to_csv('C:/Users/SriPrav/Documents/R/14Allstate/submissions/submission_keras02_2.csv', index = False)
