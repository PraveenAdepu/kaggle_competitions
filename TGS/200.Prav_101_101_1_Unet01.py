...
train_data_224_3   = np.load(inDir +"/input/train_data_101_1.npy")
train_target_224_3 = np.load(inDir +"/input/train_target_101_1.npy")
train_id_224_3     = np.load(inDir +"/input/train_id_101_1.npy")


test_data_224_3    = np.load(inDir +"/input/test_data_101_1.npy")
