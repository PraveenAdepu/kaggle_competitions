...
X_train, X_valid, X_feat_train, X_feat_valid, y_train, y_valid = train_test_split(X, X_feat, y, test_size=0.10, random_state=42)
# Normalize X_feat
...
#import pickle
#with open('preds_test_upsampled01.pkl', 'wb') as f:
#    pickle.dump(preds_test_upsampled, f)
#with open('y_valid01.pkl', 'wb') as f:
#    pickle.dump(y_valid, f)
#with open('preds_val01.pkl', 'wb') as f:
