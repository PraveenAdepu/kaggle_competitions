# -*- coding: utf-8 -*-
"""
Created on Tue May 22 06:48:45 2018
...
from keras.layers import Input, SpatialDropout1D,Dropout, GlobalAveragePooling1D, GRU, Bidirectional, Dense, Embedding
...
TRAIN_CSV = inDir+'/input/train.csv'
TEST_CSV = inDir+'/input/test.csv'
