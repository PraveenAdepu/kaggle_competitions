...
MODEL_WEIGHTS_FILE = inDir + '/Unet_CCN02_weights.h5'
...
train_data_224_3   = np.load(inDir +"/input/train_data_512_1.npy")
train_target_224_3 = np.load(inDir +"/input/train_target_512_1.npy")
train_id_224_3     = np.load(inDir +"/input/train_id_512_1.npy")
