...
testingSet = X2[:,-features:]
validationSet = X2[:,-Total_features:-horizon_periods]
trainingSet = X2
...
learning_rate = 1e-3
ModelName = 'LSTM02'
MODEL_WEIGHTS_FILE = inDir + '/Prav_LSTM_02.h5'
...
sub_file = inDir +'/submissions/Prav.'+ str(ModelName)+'-test' + '.csv'
