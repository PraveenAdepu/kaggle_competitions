...
train.to_hdf(inDir + '/input/train.h5','train') # 4746
test.to_hdf(inDir + '/input/test.h5','test')    # 4745

####################################################################################################################################

train = pd.read_hdf(inDir + '/input/train.h5','train')
test = pd.read_hdf(inDir + '/input/test.h5','test')
####################################################################################################################################
...
feature_names =  list(srp_feature_names) + list(fa_feature_names) + list(cluster_feature_names) + ['SumZeros','skewness','kurtosis','Max','Mean','Median','Var','Std','Sum','NonZeroRatio','MedianMeanRatio','MaxMinRatio','Min']#,'SumValues'
