...
sample_sub <- read_csv("./submissions/stage2_sample_submission.csv")

CNN02.fold1.test <- read_csv("./submissions/prav.FE00.bl02.fold_stg21-test.csv")
CNN02.fold2.test <- read_csv("./submissions/prav.FE00.bl02.fold_stg22-test.csv")
CNN02.fold3.test <- read_csv("./submissions/prav.FE00.bl02.fold_stg23-test.csv")
CNN02.fold4.test <- read_csv("./submissions/prav.FE00.bl02.fold_stg24-test.csv")
CNN02.fold5.test <- read_csv("./submissions/prav.FE00.bl02.fold_stg25-test.csv")
...
write_csv(submission,"./submissions/Prav.FE00.bl02_Meanfolds12345_stg2.csv")
...
CNN02.fold1.test <- read_csv("./submissions/prav.FE01.bl02.fold_stg21-test.csv")
CNN02.fold2.test <- read_csv("./submissions/prav.FE01.bl02.fold_stg22-test.csv")
CNN02.fold3.test <- read_csv("./submissions/prav.FE01.bl02.fold_stg23-test.csv")
CNN02.fold4.test <- read_csv("./submissions/prav.FE01.bl02.fold_stg24-test.csv")
CNN02.fold5.test <- read_csv("./submissions/prav.FE01.bl02.fold_stg25-test.csv")
...
write_csv(submission,"./submissions/Prav.FE01.bl02_Meanfolds12345_stg2.csv")
...
CNN02.fold1.test <- read_csv("./submissions/prav.FE00.nn01.fold_stg21-test.csv")
CNN02.fold2.test <- read_csv("./submissions/prav.FE00.nn01.fold_stg22-test.csv")
CNN02.fold3.test <- read_csv("./submissions/prav.FE00.nn01.fold_stg23-test.csv")
CNN02.fold4.test <- read_csv("./submissions/prav.FE00.nn01.fold_stg24-test.csv")
CNN02.fold5.test <- read_csv("./submissions/prav.FE00.nn01.fold_stg25-test.csv")
...
write_csv(submission,"./submissions/Prav.FE00.nn01_Meanfolds12345_stg2.csv")
...
CNN02.fold1.test <- read_csv("./submissions/prav.FE01.nn01.fold_stg21-test.csv")
CNN02.fold2.test <- read_csv("./submissions/prav.FE01.nn01.fold_stg22-test.csv")
CNN02.fold3.test <- read_csv("./submissions/prav.FE01.nn01.fold_stg23-test.csv")
CNN02.fold4.test <- read_csv("./submissions/prav.FE01.nn01.fold_stg24-test.csv")
CNN02.fold5.test <- read_csv("./submissions/prav.FE01.nn01.fold_stg25-test.csv")
...
write_csv(submission,"./submissions/Prav.FE01.nn01_Meanfolds12345_stg2.csv")
...
model1 <- read_csv("./submissions/Prav.FE01.bl02_Meanfolds12345_stg2.csv")
model2 <- read_csv("./submissions/Prav.FE00.bl02_Meanfolds12345_stg2.csv")
...
write_csv(submission,"./submissions/Prav.FE01.bl02_FE00.bl02_meanfolds_Mean_stg2.csv") 
...
model1 <- read_csv("./submissions/Prav.FE01.bl02_Meanfolds12345_stg2.csv")
model2 <- read_csv("./submissions/Prav.FE01.nn01_Meanfolds12345_stg2.csv")
...
write_csv(submission,"./submissions/Prav.FE01.bl02_nn01_meanfolds12345_Mean_stg2.csv")
####################################################################################################################################################
...
model1 <- read_csv("./submissions/Prav.FE00.bl02_Meanfolds12345_stg2.csv")
model2 <- read_csv("./submissions/Prav.FE00.nn01_Meanfolds12345_stg2.csv")
...
write_csv(submission,"./submissions/Prav.FE00.bl02_nn01_meanfolds12345_Mean_stg2.csv")
####################################################################################################################################################
