...
features_to_use.extend(["price_t","num_photos", "num_features", "num_description_words"
                        ...
                        ,'street', 'avenue', 'east', 'west', 'north', 'south','distance_to_city','manager_freq']) # ,"passed" 
...
def train_xgboost(i):
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb08.fold' + str(i) + '.csv'
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb08.fold' + str(i) + '-test' + '.csv'
...
def fulltrain_xgboost(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb08.full' + '.csv'
