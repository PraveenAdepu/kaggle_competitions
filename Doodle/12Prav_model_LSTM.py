# -*- coding: utf-8 -*-
"""
Created on Sun Nov 11 10:18:55 2018
...
print(tf.__version__) # 1.4.0 # 1.4.1
import keras
print(keras.__version__) # 2.2.2 # 2.1.2
...
val_datagen = image_generator_xd(batchsize=batchsize, ks=(NCSVS - 1))
...
valid_df = pd.read_csv(os.path.join(DP_DIR, 'train_k{}.csv.gz'.format(NCSVS - 1)), nrows=160000)
...
sub_df[['key_id', 'word']].to_csv(inDir+'/submissions/Prav_simple_model_submission_75k_LSTM.csv', index=False)
