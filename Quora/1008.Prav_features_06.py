...
train["unigrams_ques1"] = train['s_question1'].apply(lambda x: get_unigrams(str(x)))
train["unigrams_ques2"] = train['s_question2'].apply(lambda x: get_unigrams(str(x)))
...
#test['z_len1'] = test.s_question1.map(lambda x: len(str(x)))
#test['z_len2'] = test.s_question2.map(lambda x: len(str(x)))
#test['z_word_len1'] = test.s_question1.map(lambda x: len(str(x).split()))
#test['z_word_len2'] = test.s_question2.map(lambda x: len(str(x).split()))
...
test["unigrams_ques1"] = test['s_question1'].apply(lambda x: get_unigrams(str(x)))
test["unigrams_ques2"] = test['s_question2'].apply(lambda x: get_unigrams(str(x)))
...
features_to_use =  ['id','zbigrams_common_count','zbigrams_common_ratio']
sub_file = 'C:/Users/padepu/Documents/R/23Quora/input/train_feature_06.csv' 
train[features_to_use].to_csv(sub_file, index=False)

features_to_use =  ['test_id','zbigrams_common_count','zbigrams_common_ratio']
sub_file = 'C:/Users/padepu/Documents/R/23Quora/input/test_feature_06.csv' 
