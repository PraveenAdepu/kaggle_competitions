...
feature.names     <- names(trainingSet[,-which(names(trainingSet) %in% c("user_id","order_id","product_id","eval_set", "reordered", "CVindices" 
                                                                         ,"user_product_min_dow_min" 
                                                                         ,"user_product_max_dow_max"
                                                                         ,"user_product_mean_dow_mean" 
                                                                         ,"user_product_min_hour_min" 
                                                                         ,"user_product_max_hour_max" 
                                                                         ,"user_product_mean_hour_mean" 
                                                                         ,"user_product_min_prior_days_min" 
                                                                         ,"user_product_max_prior_days_max"
                                                                         ,"user_product_mean_prior_days_mean" 
                                                                         ,"user_product_min_add_to_cart_order_min" 
                                                                         ,"user_product_max_add_to_cart_order_max" 
                                                                         ,"user_product_mean_add_to_cart_order_mean"))])
