# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 08:14:31 2018
...
filename='nextClick_alldata.csv'
...
sub.to_csv(inDir+'/submissions/Prav_lgbm_baseline01.csv',index=False,float_format='%.9f')
print("done...")
