...
train_df = pd.merge(train_df, train_features_40, how = 'left', on = 'id')
test_df = pd.merge(test_df, test_features_40, how = 'left', on = 'test_id')
...
leaks = train_df[['q_dist_soundex'
                     ...
                     'z_word_match',                    
                     'q1_freq',
                     'q2_freq','q1_q2_intersect','max_kcore', "q1_pr","q2_pr"]]
