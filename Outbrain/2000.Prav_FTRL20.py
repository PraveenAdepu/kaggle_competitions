...
train = data_path+'trainingSet30_train.csv'               # path to training file
test = data_path+'trainingSet30_valid.csv'                 # path to testing file
submission = out_path+'Prav_FTRL_proba20.csv'  # path of to be outputted submission file
