...
#    model7.add(Dense(num_dense/2, activation=act))
    ...
    merged_model.add(Merge([model1, model2,model5, model6,model7], mode='concat'))
...
hist = model.fit([data_1_train, data_2_train,data_1_train, data_2_train, leaks_train], labels_train, \
        validation_data=([data_1_val, data_2_val,data_1_val, data_2_val, leaks_val], labels_val, weight_val), \
...
preds = model.predict([test_data_1, test_data_2,test_data_1, test_data_2, test_leaks], batch_size=8192, verbose=1)
preds += model.predict([test_data_2, test_data_1,test_data_2, test_data_1, test_leaks], batch_size=8192, verbose=1)
preds /= 2
