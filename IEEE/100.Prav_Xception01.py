...
images_train = pd.read_csv(inDir + '/input/Prav_5folds_CVindices_v5.csv')
images_train = images_train[images_train['image_patch_rank']<=72]
...
def model_Xception(num_classes):
    base_model = Xception( include_top=False,weights='imagenet',input_shape=( ROWS, COLUMNS,CHANNELS),pooling='avg')
...
ModelName= 'Xception_01'
i=5
def dlnet(i):
    MODEL_WEIGHTS_FILE = inDir + '/Prav_01_Xception'+str(i)+'.h5'
