...
model.add(Dropout(0.3))
model.add(Dense(8, activation='softmax'))    
#def VGG_16(size=(224, 224), weights_path='C:/Users/SriPrav/Documents/R/18Nature/input/vgg16_weights.h5'):
#    model = Sequential()
...
#    
nb_train_samples = len(glob.glob('C:/Users/SriPrav/Documents/R/18Nature/input/train_split/*/*.jpg'))
nb_validation_samples = len(glob.glob('C:/Users/SriPrav/Documents/R/18Nature/input/val_split/*/*.jpg'))
nb_epoch = 50
bath_size = 16
...
train_generator = train_datagen.flow_from_directory(
        'C:/Users/SriPrav/Documents/R/18Nature/input/train_split/',
        target_size=size,
...
validation_generator = valid_datagen.flow_from_directory(
        'C:/Users/SriPrav/Documents/R/18Nature/input/val_split/',
        target_size=size,
        batch_size=bath_size,
        shuffle = True,
        classes=classes,
...
f_submit = open(os.path.join('C:/Users/SriPrav/Documents/R/18Nature/submissions', \
                             'submit_VGGAugmentation01'  +'.csv'), 'w')
