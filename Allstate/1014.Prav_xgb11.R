  ...
  
{
  ...
  for (b in 1:bags) 
  {
    ...
    pred_cv    <- predict(XGModel, data.matrix(X_val[,feature.names]), ntreelimit = 900)
...
write.csv(testfull_predictions, './submissions/prav.xgb11_01.full.csv', row.names=FALSE, quote = FALSE)
