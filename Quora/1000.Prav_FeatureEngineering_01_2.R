...
####################################################################################################
# Use lemmatize questions for this feature extraction
####################################################################################################

train$Porterstem_question1 <- NULL
train$Porterstem_question2 <- NULL

test$Porterstem_question1 <- NULL
test$Porterstem_question2 <- NULL
####################################################################################################
...
write.csv(train.features,"./input/train_features_01_2.csv", row.names=F)
...
write.csv(test.features,"./input/test_features_01_2.csv", row.names=F)
