...
def load_data_sparse():
    ...
    data_path="C:/Users/SriPrav/Documents/R/21Rental"
    train_file = data_path + "/input/train.json"
    ...
    Prav_imagetime = data_path + "/input/listing_image_time.csv"
    ...
    Prav_features20 = data_path + "/input/Prav_features20.csv"
    ...
    "num_price_by_furniture","price_latitue","price_longtitude", "time_stamp", "price_comparison"])#,"price_latitue_longtitude"]) "created_year", #,"num_description_length"
    ...
    train_df['description'] =  train_df['description'].apply(lambda x: x if len(x)>2 else "nulldesc") 
    test_df['description'] =test_df['description'].apply(lambda x: x if len(x)>2 else "nulldesc") 
...
def main():
        ...
        train_file="train_stacknet51.csv"
        test_file="test_stacknet51.csv"
        ...
        print("Write results...")
        output_file = "submission51_"+str( (mean_logloss ))+".csv"
