...
df = pd.read_csv(inDir+"\\data\\train.csv")
df.shape

"""
forget about LB - follow cv best practice
...
df = preprocess(df)
sub_df = preprocess(pd.read_csv(inDir+"\\data\\test.csv"))
df.head()

df["Date"].min(), df["Date"].max()
# train - has public leaderboard dataset
