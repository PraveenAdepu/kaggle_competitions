...
######################################################################################################################
#np.save(inDir +"/input/train_data_rotate_aug_299_3.npy",train_data)
#np.save(inDir +"/input/train_target_rotate_aug_299_3.npy",train_target)
#np.save(inDir +"/input/train_id_rotate_aug_299_3.npy",train_id)

np.save(inDir +"/input/test_data_rotate_aug_299_3.npy",test_data)
np.save(inDir +"/input/test_id_rotate_aug_299_3.npy",test_id)
######################################################################################################################
