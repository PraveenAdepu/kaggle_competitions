...
for (i in 1:cv)
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl03.fold1.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl03.fold1-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 2)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl03.fold2.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl03.fold2-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 3)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl03.fold3.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl03.fold3-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 4)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl03.fold4.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl03.fold4-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 5)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl03.fold5.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl03.fold5-test.csv", sep=''), row.names=FALSE, quote = FALSE)
...
head(fulltest_predictions)
write.csv(fulltest_predictions,paste(root_directory, "./submissions/prav.dl03.full.csv", sep=''), row.names=FALSE, quote = FALSE)
