...
def write_rectangles_csv():
    ...
    out = open('rectangles_test2.csv', "w")
    out.write("image_name,image_path,type,clss,img_shp_0_init,img_shape1_init,img_shp_0,img_shp_1,sh0_start,sh1_start,sh0_end,sh1_end\n")
    # for f in sorted(train_files + test_files + additional_files):  
        
    path = os.path.join('C:\Users\SriPrav\Documents\R\\22Intel', 'input', 'stage2','test', '*.jpg')
...
#Contour problem for C:\Users\SriPrav\Documents\R\22Intel\input\train\Type_1\a_Type_1\6361.jpg. skip it!