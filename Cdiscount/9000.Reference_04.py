...
train_gen = BinFileIterator('train.bin', img_generator=train_img_gen,  samples=100000,
                 target_size=(180,180), 
                 batch_size=100)  

val_img_gen = ImageDataGenerator() #Configure as you want
val_gen = BinFileIterator('val.bin', img_generator=val_img_gen,  samples=20000,
                 target_size=(180,180), 
                 batch_size=100) 

# To train the model:
model.fit_generator(train_gen,
                    steps_per_epoch = 100000/100,   #num_train_images // batch_size,
                    epochs = 2,
                    validation_data = val_gen,
                    validation_steps = 20000/100,  #num_val_images // batch_size,
                    workers = 4)
