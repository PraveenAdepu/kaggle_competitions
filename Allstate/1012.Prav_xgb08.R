  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  'prav.xgb08.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb08.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  'prav.xgb08.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb08.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  'prav.xgb08.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb08.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  'prav.xgb08.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb08.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  'prav.xgb08.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb08.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
