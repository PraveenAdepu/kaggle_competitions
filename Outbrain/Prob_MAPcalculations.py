# -*- coding: utf-8 -*-
"""
Created on Fri Jan 13 00:16:17 2017
...
df_train = pd.read_csv( "C:/Users/SriPrav/Documents/R/13Outbrain/submissions/testingSet20_valid_probs.csv")
...
df_train.sort_values(['display_id', 'Prob_clicked'], inplace=True, ascending=[True, False] )
