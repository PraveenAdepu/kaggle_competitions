...
checkpoint = ModelCheckpoint(inDir+'/base.model', monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='min', period=1)
...
bestModel = load_model(inDir+'/base.model', custom_objects={'f1': f1}) #, 'f1_loss': f1_loss})
...
submit.to_csv(inDir+'/submissions/Prav_CNN01.csv', index=False)
