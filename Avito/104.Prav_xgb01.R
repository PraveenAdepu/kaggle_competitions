  ...
  
{
  ...
  test_predictions <- data.frame(item_id=te$item_id, deal_probability = pred_test_bags)
   ...
   if(i == 1)
   {
     write.csv(val_predictions,  './submissions/Prav.xgb1.fold1.csv', row.names=FALSE, quote = FALSE)
     write.csv(test_predictions, './submissions/Prav.xgb1.fold1-test.csv', row.names=FALSE, quote = FALSE)
   }
   if(i == 2)
   {
     write.csv(val_predictions,  './submissions/Prav.xgb1.fold2.csv', row.names=FALSE, quote = FALSE)
     write.csv(test_predictions, './submissions/Prav.xgb1.fold2-test.csv', row.names=FALSE, quote = FALSE)
   }
   if(i == 3)
   {
     write.csv(val_predictions,  './submissions/Prav.xgb1.fold3.csv', row.names=FALSE, quote = FALSE)
     write.csv(test_predictions, './submissions/Prav.xgb1.fold3-test.csv', row.names=FALSE, quote = FALSE)
   }
   if(i == 4)
   {
     write.csv(val_predictions,  './submissions/Prav.xgb1.fold4.csv', row.names=FALSE, quote = FALSE)
     write.csv(test_predictions, './submissions/Prav.xgb1.fold4-test.csv', row.names=FALSE, quote = FALSE)
   }
   if(i == 5)
   {
     write.csv(val_predictions,  './submissions/Prav.xgb1.fold5.csv', row.names=FALSE, quote = FALSE)
     write.csv(test_predictions, './submissions/Prav.xgb1.fold5-test.csv', row.names=FALSE, quote = FALSE)
   }
...
write.csv(testfull_predictions, './submissions/Prav.xgb1.full.csv', row.names=FALSE, quote = FALSE)
