...
MODEL_WEIGHTS_FILE = inDir + '/Prav_Model11.h5'

callbacks = [
    ReduceLROnPlateau(monitor='val_categorical_accuracy', factor=0.5, patience=2,min_delta=0.005, mode='max', cooldown=3, verbose=1),
