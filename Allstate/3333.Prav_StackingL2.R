...
xgb20.fold1 <- read_csv("./submissions/prav.xgb20.fold1.csv")
xgb20.fold2 <- read_csv("./submissions/prav.xgb20.fold2.csv")
xgb20.fold3 <- read_csv("./submissions/prav.xgb20.fold3.csv")
xgb20.fold4 <- read_csv("./submissions/prav.xgb20.fold4.csv")
xgb20.fold5 <- read_csv("./submissions/prav.xgb20.fold5.csv")
xgb20.full  <- read_csv("./submissions/prav.xgb20.full.csv")
