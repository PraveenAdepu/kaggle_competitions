...
MODEL_WEIGHTS_FILE = inDir + '/Unet_CCN04_weights.h5'
...
#    conv6 = double_conv_layer(up5, 256, dropout_val, batch_norm)
    ...
    up6 = merge([UpSampling2D(size=(2, 2))(conv4), conv3], mode='concat', concat_axis=1)
    conv7 = double_conv_layer(up6, 128, dropout_val, batch_norm)
...
#
#    conv12 = Convolution2D(1, 1, 1, border_mode='same')(conv11)
...
train_data_224_3, train_target_224_3, train_id_224_3 = read_and_normalize_train_data()

#train_data_224_3   = train_data #np.load(inDir +"/input/train_data_512_1.npy")
#train_target_224_3 = train_target #np.load(inDir +"/input/train_target_512_1.npy")
#train_id_224_3     = train_id #np.load(inDir +"/input/train_id_512_1.npy")
#
#del train_data,train_target,train_id

#test_data_224_3    = np.load(inDir +"/input/test_data_512_1.npy")
#test_id_224_3      = np.load(inDir +"/input/test_id_512_1.npy")
# 
...
#
train_data_224_3 = train_data_224_3.astype('float16')

train_target_224_3 = train_target_224_3.astype('float16')
train_target_224_3 /= 255.  # scale masks to [0, 1]

#test_data_224_3,test_id_224_3 =  read_and_normalize_test_data()
...
#    pred_test.to_csv(sub_file, index=False)  
    ...
    #np.save('imgs_mask_val10_Unet_CNN02.npy', imgs_mask_val)
...
#    val_image = (val_image[:, :, 0] * 255.).astype(np.uint8)
    ...
    #np.save('imgs_mask_test10_Unet_CNN02.npy', imgs_mask_test)
