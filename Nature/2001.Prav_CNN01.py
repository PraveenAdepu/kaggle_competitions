...
submission_file_path = inDir +  '/submissions/Prav_CNN01_stg2.csv'
...
def load_train():
    ...
    for fld in folders:
        ...
        path = os.path.join(inDir, 'input', 'train', fld, '*.jpg')
...
def load_test():
    path = os.path.join(inDir, 'input', 'test','test_stg2', '*.jpg')
