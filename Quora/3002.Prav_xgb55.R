...
names(test_features_53[,c(2:53)])

train_features_53 = read.csv("./input/train_features_53.csv")
test_features_53  = read.csv("./input/test_features_53.csv")

train_features_53[,c(2:53)] <- sapply(train_features_53[,c(2:53)], as.numeric)
test_features_53[,c(2:53)]  <- sapply(test_features_53[,c(2:53)], as.numeric)
...
feature.names     <- c('q_dist_soundex'
                       ...
                       "wmd" ,
                       "norm_wmd"
                       ,"q1_anger"    , "q1_anticipation"
                       ,"q1_disgust"  , "q1_fear"         ,"q1_joy"          ,"q1_sadness"     , "q1_surprise"  ,   "q1_trust" , "q1_negative"    
                       ,"q1_positive" , "q2_anger"        ,"q2_anticipation" ,"q2_disgust"     , "q2_fear"      ,   "q2_joy"   , "q2_sadness"     
                       ,"q2_surprise" , "q2_trust"        ,"q2_negative"     ,"q2_positive" 
  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  './submissions/prav.xgb55.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb55.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  './submissions/prav.xgb55.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb55.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  './submissions/prav.xgb55.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb55.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  './submissions/prav.xgb55.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb55.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  './submissions/prav.xgb55.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb55.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
...
write.csv(testfull_predictions, './submissions/prav.xgb55.full.csv', row.names=FALSE, quote = FALSE)
...
sub_valfile = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb55.fold' + str(i) + '.csv'
...
sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb55.fold' + str(i) + '-test' + '.csv'
...
sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.xgb55.full' + '.csv'
