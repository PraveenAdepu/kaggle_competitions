...
train_file_03 = inDir + "/input/Prav_FE_25.csv"
train_df_03 = pd.read_csv(train_file_03)
print(train_df_03.shape) # (558352, 41)

train_df = pd.merge(train_df, train_df_03, how = 'left', on = 'Patient_ID')

train_file_04 = inDir + "/input/Prav_FE_26.csv"
train_df_04 = pd.read_csv(train_file_04)
print(train_df_04.shape) # (558352, 41)

train_df = pd.merge(train_df, train_df_04, how = 'left', on = 'Patient_ID')
