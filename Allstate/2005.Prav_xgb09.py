...
if __name__ == "__main__":
    ...
    print('\nStarted')
    directory = 'C:/Users/padepu/Documents/R/14Allstate/input/'
    ...
    train.to_csv('C:/Users/padepu/Documents/R/14Allstate/input/train_preprocess.csv', index=True, index_label='id')
    test.to_csv('C:/Users/padepu/Documents/R/14Allstate/input/test_preprocess.csv', index=True, index_label='id')
    
    ids = pd.read_csv('C:/Users/padepu/Documents/R/14Allstate/input/test.csv')['id']
    ...
    sub_file = 'C:/Users/padepu/Documents/R/14Allstate/submissions/submission_5fold-average-xgb_fairobj_' + str(score) + '_' + str(
