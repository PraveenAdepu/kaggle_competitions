...
# write.csv(build_set, "./input/build_set_FE_01.csv", row.names=FALSE, quote = FALSE)

trainingSet <- subset(build_set, Patient_ID < 279201 )
testingSet  <- subset(build_set, Patient_ID >= 279201 )

length(unique(build_set$Prescriber_ID))
##################################################################################################################
...
########################################################################################################################
# 246 features
feature.names     <- names(trainingSet[,-which(names(trainingSet) %in% c("Patient_ID", "DispenseDate" ,"DiabetesDispense", "CVindices","X13","IsDeferredScript"
  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  './submissions/prav.xgb12.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb12.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  './submissions/prav.xgb12.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb12.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  './submissions/prav.xgb12.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb12.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  './submissions/prav.xgb12.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb12.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  './submissions/prav.xgb12.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, './submissions/prav.xgb12.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
...
write.csv(testfull_predictions, './submissions/prav.xgb12.full.csv', row.names=FALSE, quote = FALSE)
...
val_sub <- read.csv("./submissions/prav.xgb12.full.csv")
...
head(Final_sub,10)
write.csv(Final_sub,  './submissions/Prav_xgb12_rank.csv', row.names=FALSE, quote = FALSE)
#########################################################################################################
