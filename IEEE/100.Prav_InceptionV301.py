...
MODEL_WEIGHTS_FILE = inDir + '/Prav_01_Inception.h5'
...
def model_Inception_V3(num_classes):  
...
#        model = CustomeNet(num_classes=num_classes)
        model = model_Inception_V3(num_classes=num_classes)
        callbacks = [
