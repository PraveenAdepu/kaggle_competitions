...
######################################################################################################################
np.save(inDir +"/input/train_data_1024_1.npy",train_data)
np.save(inDir +"/input/train_target_1024_1.npy",train_target)
np.save(inDir +"/input/train_id_1024_1.npy",train_id)

np.save(inDir +"/input/test_data_1024_1.npy",test_data)
np.save(inDir +"/input/test_id_1024_1.npy",test_id)
######################################################################################################################
