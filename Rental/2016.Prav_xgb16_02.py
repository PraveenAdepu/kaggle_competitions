...
train_Ref.columns = ['listing_id', 'building_id_mean_med', 'building_id_mean_high',
       'manager_id_mean_med', 'manager_id_mean_high', 'building_id_Ref',
       'display_address_Ref', 'manager_id_Ref', 'street_address_Ref']
       
test_Ref.columns = ['listing_id', 'building_id_mean_med', 'building_id_mean_high',
       'manager_id_mean_med', 'manager_id_mean_high', 'building_id_Ref',
       'display_address_Ref', 'manager_id_Ref', 'street_address_Ref']
...
def train_xgboost(i):
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb1601.fold' + str(i) + '.csv'
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb1601.fold' + str(i) + '-test' + '.csv'
...
def fulltrain_xgboost(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb1602.full' + '.csv'
