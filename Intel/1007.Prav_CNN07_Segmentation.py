...
#train_df = train_df[~train_df['image_path'].str.contains('a_')]
train_df.head(2)
...
#    model.add(ZeroPadding2D((1, 1), dim_ordering='th'))
    model.add(Convolution2D(512, 3, 3, activation='relu', dim_ordering='th', init='he_uniform'))  
#    model.add(ZeroPadding2D((1, 1), dim_ordering='th'))
    model.add(Convolution2D(512, 3, 3, activation='relu', dim_ordering='th', init='he_uniform'))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), dim_ordering='th'))
    model.add(Dropout(0.2))
...
#    model.add(ZeroPadding2D((1, 1), dim_ordering='th'))
    ...
    model.add(Flatten())
    model.add(Dense(4096, activation='relu',init='he_uniform'))
    model.add(Dropout(0.4))
    model.add(Dense(2048, activation='relu',init='he_uniform'))
    model.add(Dropout(0.2))
    model.add(Dense(3, activation='softmax'))
    
    model.add(Dense(1024, activation='relu',init='he_uniform'))
    model.add(Dropout(0.2))
    model.add(Dense(3, activation='softmax'))
