...
MODEL_WEIGHTS_FILE = 'nn105_question_pairs_weights.h5'
...
#        os.remove('C:/Users/SriPrav/Documents/R/23Quora/nn50_question_pairs_weights.h5')
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn105.fold' + str(i) + '.csv'    
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn105.fold' + str(i) + '-test' + '.csv'
...
#    checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=0, save_best_only=True)
    ...
    pred_test["test_id"] = testingSet.test_id.values
    pred_test = pred_test[['test_id','is_duplicate']]
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn105.full' + '.csv'
    pred_test.to_csv(sub_file, index=False)   
