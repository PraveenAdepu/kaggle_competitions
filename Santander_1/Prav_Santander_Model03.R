...
## loading raw data
train <- fread(path_train_file, showProgress = T)
test <- fread(path_test_file, showProgress = T)
...
## xgboost training
model_xgb_1 <- xgb.train(params = params, xgtrain1, nrounds = 140, nthread = 12,print_every_n = 10)
model_xgb_2 <- xgb.train(params = params, xgtrain2, nrounds = 140, nthread = 12,print_every_n = 10)
