...
Prav_train_features12 = inDir + "/input/Prav_train_features12.csv"
Prav_train_features12 = pd.read_csv(Prav_train_features12)

Prav_test_features12 = inDir + "/input/Prav_test_features12.csv"
Prav_test_features12 = pd.read_csv(Prav_test_features12)

train_df = pd.merge(train_df, Prav_train_features12, how = 'left', on = 'listing_id')
test_df = pd.merge(test_df, Prav_test_features12, how = 'left', on = 'listing_id')
...
def train_xgboost(i):
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb25.fold' + str(i) + '.csv'
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb25.fold' + str(i) + '-test' + '.csv'
...
def fulltrain_xgboost(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb25.full' + '.csv'
