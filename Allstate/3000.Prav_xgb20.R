...
# write.csv(trainingSet,  './input/train_RFsource.csv', row.names=FALSE, quote = FALSE)
# write.csv(testingSet,  './input/test_RFsource.csv', row.names=FALSE, quote = FALSE)
  ...
  
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions,  'prav.xgb20.fold1.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb20.fold1-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 2)
  {
    write.csv(val_predictions,  'prav.xgb20.fold2.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb20.fold2-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 3)
  {
    write.csv(val_predictions,  'prav.xgb20.fold3.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb20.fold3-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 4)
  {
    write.csv(val_predictions,  'prav.xgb20.fold4.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb20.fold4-test.csv', row.names=FALSE, quote = FALSE)
  }
  if(i == 5)
  {
    write.csv(val_predictions,  'prav.xgb20.fold5.csv', row.names=FALSE, quote = FALSE)
    write.csv(test_predictions, 'prav.xgb20.fold5-test.csv', row.names=FALSE, quote = FALSE)
  }
...
write.csv(testfull_predictions, './submissions/prav.xgb20.full.csv', row.names=FALSE, quote = FALSE)
