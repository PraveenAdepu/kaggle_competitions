...
MODEL_WEIGHTS_FILE = inDir + '/Prav_01_densenet121.h5'
densenet121_weights = inDir + '/preModels/densenet121_weights_tf.h5'
...
# execute 100.Prav_All_densenets.py
def densenet_121(num_classes):
    base_model = DenseNetImageNet121(input_shape=(ROWS, COLUMNS, CHANNELS),
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
