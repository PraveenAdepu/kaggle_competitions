...
FeatureFiles_stg2 = inDir + "/input/FeatureExtraction_01_stg2/%s.npy"
...
MODEL_WEIGHTS_FILE = 'FE01_dsb_nn01_weights_stg2.h5'
...
#    m.fit(trn_x, trn_y, batch_size=32, nb_epoch=15, validation_data=(val_x, val_y), verbose=2,callbacks=callbacks)     
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE01.nn01.fold_stg2' + str(i) + '.csv'
    pred_cv.to_csv(sub_valfile, index=False)    
    pred_test =[p[0] for p in m.predict(test_x)] #
    test_df['cancer'] = pred_test
    
    sub_file = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE01.nn01.fold_stg2' + str(i) + '-test' + '.csv'
...
def fulltrain_nnet(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav.FE01.nn01_stg2.full' + str(i) + '-bags' + '.csv'
    test_df.to_csv(sub_file, index=False)
