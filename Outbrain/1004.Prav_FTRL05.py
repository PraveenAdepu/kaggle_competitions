...
train = data_path+'trainingSet5_20161215.csv'               # path to training file
test = data_path+'testingSet5_20161215.csv'                 # path to testing file
submission = out_path+'Prav_FTRL_proba05.csv'  # path of to be outputted submission file
