# -*- coding: utf-8 -*-
"""
Created on Fri Nov  3 21:04:26 2017
...
train = pd.read_csv(inDir + '/input/train.csv', usecols=[1,2,3,4], dtype=dtypes, parse_dates=['date'],
...
#Load test
test = pd.read_csv(inDir+"/input/test.csv", usecols=[0,2,3], dtype=dtypes)
...
#test[['id','unit_sales']].to_csv(inDir+'submissions/median_ma6.csv.gz', index=False, float_format='%.3f', compression='gzip')
test[['id','unit_sales']].to_csv(inDir+'/submissions/Prav_mean01.csv', index=False, float_format='%.3f')
