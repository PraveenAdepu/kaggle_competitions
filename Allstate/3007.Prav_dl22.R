...
trainingSet <- h2o.importFile("./input/train_nnetthreecombifeatures.csv", destination_frame = "trainingSet.hex")
testingSet  <- h2o.importFile("./input/test_nnetthreecombifeatures.csv", destination_frame = "testingSet.hex")
...
for (i in 1:1)
{
  ...
  for (b in 1:bags) 
  {
    ...
    Model <- h2o.deeplearning(
      ...
      distribution="huber",
      hidden=c(160,160,160),			      # select hidden topology (smaller is faster)
      epochs=10,				                # add more to increase accuracy
      #adaptive_rate=T,
      # standardize = TRUE,
  ...
  # if(i == 1)
  # {
  #   write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl22.fold1.csv", sep=''), row.names=FALSE, quote = FALSE)
  #   write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl22.fold1-test.csv", sep=''), row.names=FALSE, quote = FALSE)
  # 
  # 
  # }
  # if(i == 2)
  # {
  #   write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl22.fold2.csv", sep=''), row.names=FALSE, quote = FALSE)
  #   write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl22.fold2-test.csv", sep=''), row.names=FALSE, quote = FALSE)
  # 
  # 
  # }
  # if(i == 3)
  # {
  #   write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl22.fold3.csv", sep=''), row.names=FALSE, quote = FALSE)
  #   write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl22.fold3-test.csv", sep=''), row.names=FALSE, quote = FALSE)
  # 
  # 
  # }
  # if(i == 4)
  # {
  #   write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl22.fold4.csv", sep=''), row.names=FALSE, quote = FALSE)
  #   write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl22.fold4-test.csv", sep=''), row.names=FALSE, quote = FALSE)
  # 
  # 
  # }
  # if(i == 5)
  # {
  #   write.csv(val_predictions, paste(root_directory, "/submissions/prav.dl22.fold5.csv", sep=''), row.names=FALSE, quote = FALSE)
  #   write.csv(test_predictions,paste(root_directory, "./submissions/prav.dl22.fold5-test.csv", sep=''), row.names=FALSE, quote = FALSE)
  # 
  # 
  # }
...
write.csv(fulltest_predictions,paste(root_directory, "./submissions/prav.dl22.full.csv", sep=''), row.names=FALSE, quote = FALSE)
