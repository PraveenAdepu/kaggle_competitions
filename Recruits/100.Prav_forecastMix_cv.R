...
# train_sub <- train_sub[visit_date < as.Date("2017-03-12"), ]

train_sub <- air_visit[visit_date < as.Date("2017-03-12"), ]
...
colnames(fcst_matrix_mix) <- as.character(
  seq(from = as.Date("2017-03-12"), to = as.Date("2017-04-19"), by = 'day'))
...
head(fcst_df_long)
names(fcst_df_long) <- c("air_store_id","visit_date","visitor_forecastMix")

write.csv(fcst_df_long, "./submissions/Prav_forecastMix_validation_preds.csv",row.names = FALSE, quote = FALSE)
############################################################################################################################################
############################################################################################################################################
...
write.csv(fcst_df_long, "./submissions/Prav.forecastMixfull-test.csv",row.names = FALSE, quote = FALSE)
############################################################################################################################################
############################################################################################################################################
