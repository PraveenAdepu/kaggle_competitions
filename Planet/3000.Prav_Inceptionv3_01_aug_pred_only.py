...
test_data_299_3    = np.load(inDir +"/input/test_data_hflip_aug_299_3.npy")
test_id_299_3      = np.load(inDir +"/input/test_id_hflip_aug_299_3.npy")
...
#    pred_cv.to_csv(sub_valfile, index=False)
    ...
    sub_file = inDir + '/submissions/Prav.Inceptionv3_01_h.fold' + str(i) + '-test'+'.csv'
