  ...
  
{
  ...
  write.csv(pred_cv_predictions, './submissions/prav.xgb01.bags5Prob.fold1.csv', row.names=FALSE, quote = FALSE)
}
...
write.csv(testfull_predictions, './submissions/prav.xgb01.bags5Prob.full.csv', row.names=FALSE, quote = FALSE)
...
write.csv(testfull_predictions_submission, './submissions/prav.xgb01.bags5Prob.full.submission.csv', row.names=FALSE, quote = FALSE)
