...
MODEL_WEIGHTS_FILE = inDir + '/Prav_vgg_01.h5'
ROWS     = 75
COLUMNS  = 75
CHANNELS = 3
nb_epoch = 100
...
#    checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=0, save_best_only=True)
    ...
    sub_valfile = inDir+'/submissions/Prav.vgg01.fold' + str(i) + '.csv'
    ...
    sub_file = inDir+'/submissions/Prav.vgg01.fold' + str(i) + '-test' + '.csv'
