...
MODEL_WEIGHTS_FILE = inDir + '/Densenet161_CCN02_weights.h5'
...
test_data_224_3    = np.load(inDir +"/input/test_data_hflip_aug_224_3.npy")
test_id_224_3      = np.load(inDir +"/input/test_id_hflip_aug_224_3.npy")
...
#for c in range(3):
#    train_data_224_3[:, c, :, :]            = ( train_data_224_3[:, c, :, :] - mean_pixel[c])            * 0.017
#    train_data_rotate_aug_224_3[:, c, :, :] = ( train_data_rotate_aug_224_3[:, c, :, :] - mean_pixel[c]) * 0.017
#    train_data_hflip_aug_224_3[:, c, :, :]  = ( train_data_hflip_aug_224_3[:, c, :, :] - mean_pixel[c])  * 0.017
# train_data /= 255
    
test_data_224_3 = test_data_224_3.astype('float32')
#test_data_224_3 = test_data_224_3 / 255
for c in range(3):
    test_data_224_3[:, c, :, :] = (test_data_224_3[:, c, :, :] - mean_pixel[c]) * 0.017
...
#    print('Split valid: ', len(X_valid), len(y_valid)) #('Split valid: ', 4009, 4009)
    base_model = densenet161_model(ROWS, COLUMNS, CHANNELS, num_classes=17) 
...
#    
#    sub_valfile = inDir + '/submissions/Prav.dense161_02.fold' + str(i) + '.csv'
...
#    pred_cv.to_csv(sub_valfile, index=False)
    ...
    sub_file = inDir + '/submissions/Prav.dense161_02_h.fold' + str(i) + '-test'+'.csv'
