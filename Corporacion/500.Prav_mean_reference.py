# -*- coding: utf-8 -*-
"""
Created on Tue Dec 26 20:44:13 2017
...
#Load test
test = pd.read_csv(inDir+'/input/test.csv', dtype=dtypes, parse_dates=['date'])
...
test[['id','unit_sales']].to_csv(inDir+'/submissions/Prav_mean_baseline.csv', index=False)#, float_format='%.3f', compression='gzip'