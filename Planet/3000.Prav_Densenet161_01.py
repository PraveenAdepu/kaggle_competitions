...
def train_nn(i):
    ...
    model = densenet161_model(ROWS, COLUMNS, CHANNELS, num_classes=17)    
#        callbacks = [
...
#              metrics=["accuracy"])
    ...
    sub_valfile = inDir + '/submissions/Prav.dense161_01.fold' + str(i) + '.csv'
    ...
    sub_file = inDir + '/submissions/Prav.dense161_01.fold' + str(i) + '-test'+'.csv'
