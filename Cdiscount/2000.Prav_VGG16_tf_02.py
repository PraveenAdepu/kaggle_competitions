...
MODEL_WEIGHTS_FILE = inDir + '/Prav_VGG16_01.h5'
...
train_gen = BinFileIterator('train.bin', img_generator=train_img_gen,  samples=9902648,
                 target_size=(180,180), 
                 batch_size=batch_size)  

val_img_gen = ImageDataGenerator(rescale=1./255) #Configure as you want
val_gen = BinFileIterator('val.bin', img_generator=val_img_gen,  samples=2468645,
                 target_size=(180,180), 
                 batch_size=batch_size) 
