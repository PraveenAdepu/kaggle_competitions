...
MODEL_WEIGHTS_FILE = inDir + '/inception4_CCN01_weights.h5'
...
for c in range(3):
    train_data_299_3[:, c, :, :] = train_data_299_3[:, c, :, :] - mean_pixel[c]
# train_data /= 255
    
test_data_299_3 = test_data_299_3.astype('float32')
#test_data_224_3 = test_data_224_3 / 255
for c in range(3):
    test_data_299_3[:, c, :, :] = test_data_299_3[:, c, :, :] - mean_pixel[c]
...
def train_nn(i):
    ...
    X_build , X_valid = train_data_299_3[trainindex,:], train_data_299_3[valindex,:]
    y_build , y_valid = train_target_299_3[trainindex,:], train_target_299_3[valindex,:]  
...
#              metrics=["accuracy"])
    ...
    sub_valfile = inDir + '/submissions/Prav.Inception4_01.fold' + str(i) + '.csv'
    ...
    pred_test = model.predict(test_data_299_3,verbose=1)
    ...
    sub_file = inDir + '/submissions/Prav.Inception4_01.fold' + str(i) + '-test'+'.csv'
