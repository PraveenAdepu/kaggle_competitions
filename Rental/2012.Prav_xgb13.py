...
train_df['building_flag'] = train_df['building_id'].apply(lambda x: 0 if x == 0 else 1)
test_df['building_flag']  = test_df['building_id'].apply(lambda x: 0 if x == 0 else 1)
...
features_to_use.extend(["price_t","num_photos", "num_features", "num_description_words"
                        ...
                        ,'street', 'avenue', 'east', 'west', 'north', 'south','distance_to_city','DuplicateImage_Ratio','building_flag']) # ,"passed" ,'manager_freq'
categorical = ["display_address", "manager_id","maxMake"] # , "building_id" ,"street_address"
