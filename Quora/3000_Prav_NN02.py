...
#        model.load_weights('C:/Users/SriPrav/Documents/R/23Quora/nn2_question_pairs_weights.h5')
        model.fit(X_train.values, X_trainy, nb_epoch=epochs, batch_size=batchsize,  verbose=verboselog,validation_data=(X_valid.values,X_validy))
...
#        os.remove('C:/Users/SriPrav/Documents/R/23Quora/nn2_question_pairs_weights.h5')
    pred_cv /= nbags
    pred_test/= nbags
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn02.fold' + str(i) + '.csv'    
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn02.fold' + str(i) + '-test' + '.csv'
...
#    checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=0, save_best_only=True)
    ...
    pred_test["test_id"] = test_df.test_id.values
    pred_test = pred_test[['test_id','is_duplicate']]
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn02.full' + '.csv'
    pred_test.to_csv(sub_file, index=False)   
