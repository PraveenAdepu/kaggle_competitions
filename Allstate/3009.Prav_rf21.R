...
trainingSet <- h2o.importFile("./input/train_RFSource.csv", destination_frame = "trainingSet.hex")
testingSet  <- h2o.importFile("./input/test_RFSource.csv", destination_frame = "testingSet.hex")
...
for (i in 1:cv)
{
  ...
  if(i == 1)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.rf21.fold1.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.rf21.fold1-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 2)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.rf21.fold2.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.rf21.fold2-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 3)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.rf21.fold3.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.rf21.fold3-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 4)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.rf21.fold4.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.rf21.fold4-test.csv", sep=''), row.names=FALSE, quote = FALSE)
    
    
  }
  if(i == 5)
  {
    write.csv(val_predictions, paste(root_directory, "/submissions/prav.rf21.fold5.csv", sep=''), row.names=FALSE, quote = FALSE)
    write.csv(test_predictions,paste(root_directory, "./submissions/prav.rf21.fold5-test.csv", sep=''), row.names=FALSE, quote = FALSE)
...
write.csv(fulltest_predictions,paste(root_directory, "./submissions/prav.rf21.full.csv", sep=''), row.names=FALSE, quote = FALSE)


#head(testfull_predictions)
####################################################################################################
h2o.scoreHistory(FullModel)
impMatrix <- as.data.frame(h2o.varimp(FullModel))
write.csv(impMatrix,paste(root_directory, "./submissions/prav.rf21.ImpMatrix.csv", sep=''), row.names=FALSE, quote = FALSE)
