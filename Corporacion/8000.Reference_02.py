# -*- coding: utf-8 -*-
"""
Created on Wed Nov  8 18:48:54 2017
...
#Load test
test = pd.read_csv(inDir+'/input/test.csv', usecols=[0,1,2,3], dtype=dtypes, parse_dates=['date'])
...
test[['id','unit_sales']].to_csv(inDir+'/submissions/Prav_mean02.csv', index=False, float_format='%.3f')