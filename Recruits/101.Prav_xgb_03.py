...
data = {
    ...
    'ar': pd.read_csv(inDir + '/input/air_reserve_cvAdjusted.csv'),
    'hr': pd.read_csv(inDir + '/input/hpg_reserve_cvAdjusted.csv'),
...
sub_file = inDir +'/submissions/Prav_xgb03_validation_preds.csv'
