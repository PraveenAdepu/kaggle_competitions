...
EMBEDDING_DIM = 300
MODEL_WEIGHTS_FILE = 'dn71_question_pairs_weights.h5'
...
Q1 = Sequential()
Q1.add(Embedding(nb_words + 1, EMBEDDING_DIM, input_length=MAX_SEQUENCE_LENGTH))#, dropout=0.2
...
Q2 = Sequential()
Q2.add(Embedding(nb_words + 1, EMBEDDING_DIM, input_length=MAX_SEQUENCE_LENGTH))#, dropout=0.2
...
model.load_weights('C:/Users/SriPrav/Documents/R/23Quora/dn71_question_pairs_weights.h5')
...
sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.deepnet071.csv'
