...
conf['samples_train_per_epoch'] = 223600 #10000
# Number of random samples to use during validation per epoch
conf['samples_valid_per_epoch'] = 24855 #1000
...
def create_submission(model):
    ...
    sample_subm.to_csv("C:/Users/SriPrav/Documents/R/19DSB2017/submissions/Prav_CNN_01.csv", index=False)
