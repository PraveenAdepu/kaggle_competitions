...
MODEL_WEIGHTS_FILE = 'nn3_question_pairs_weights.h5'
...
def nn_model(inputcols):
    model = Sequential()
    
    model.add(Dense(400, input_dim = inputcols, init = 'he_normal'))
    model.add(PReLU())
...
def nnet(i):
    ...
    for j in range(1,nbags+1):
        ...
        model.load_weights('C:/Users/SriPrav/Documents/R/23Quora/nn3_question_pairs_weights.h5')
        ...
        os.remove('C:/Users/SriPrav/Documents/R/23Quora/nn3_question_pairs_weights.h5')
    pred_cv /= nbags
    pred_test/= nbags
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn03.fold' + str(i) + '.csv'    
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn03.fold' + str(i) + '-test' + '.csv'
...
#    checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=0, save_best_only=True)
    ...
    pred_test["test_id"] = test_df.test_id.values
    pred_test = pred_test[['test_id','is_duplicate']]
    sub_file = 'C:/Users/SriPrav/Documents/R/23Quora/submissions/Prav.nn03.full' + '.csv'
    pred_test.to_csv(sub_file, index=False)   
