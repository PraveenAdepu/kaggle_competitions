...
def train_xgboost(i):
    ...
    sub_valfile = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb17.fold' + str(i) + '.csv'
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb17.fold' + str(i) + '-test' + '.csv'
...
def fulltrain_xgboost(bags):
    ...
    sub_file = 'C:/Users/SriPrav/Documents/R/21Rental/submissions/Prav.xgb17.full' + '.csv'
